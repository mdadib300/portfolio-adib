    ...
    return (
        <div id="projects" className="bg-[#fdfcdc] text-[#293241] pb-10">
            ...
            <div className="flex justify-center">
                <a href="https://github.com/mdadib300?tab=repositories" target="_blank" className="tooltip tooltip-right" data-tip="See my all projects at GitHub!"><Button btnText={"See More"}></Button></a>
            </div>
        </div>
    );
};
